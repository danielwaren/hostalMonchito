...
type SidebarState = typeof SIDEBAR_STATES[number]
  ...
  ({
    ...
    return (
      <div
        ...
        className={cn(
          "group/sidebar relative flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground transition-[width] duration-300 ease-in-out",
